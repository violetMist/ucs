...
<div id="body" class="sys">
	<div class="col-1">
		<div class="sys-pie">
			<div class="sys-title"><div class="icon-device-pic"></div>系统设备统计</div>
			<div class="pie-box">
	...
	<div class="col-2">
		<div class="sys-wave">
			<div class="sys-title"><div class="icon-storage-pic"></div>存储空间统计</div>
			<Wave 
				:used="waveData.used"
				:all = "waveData.all"
			></Wave>
	...
	<div class="col-3">
		<div class="sys-r-broken">
			<div class="sys-title"><div class="icon-video-pic"></div>视频集群</div>
			<div class="tabs">
				<div :class="{
					'tab': true,
					'active':  showVideo == 'rw'
		...
		<div class="sys-p-broken">
			<div class="sys-title"><div class="icon-pfs-pic"></div>文件集群</div>
			<div class="tabs">
				<div :class="{
					'read-write': true, 
					'tab': true
	...
	export default {
		data () {
			return {
				...
				cubeData: [],
				translates: ['translate(10, 0)', 'translate(70, 0)', 'translate(170, 0)', 'translate(230, 0)'],
